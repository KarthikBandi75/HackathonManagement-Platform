            ...
            >
                ...
                {!isSubmitted ? (
                    ...
                    >
                        ...
                        >
                            <Input icon={Mail} type="email" placeholder="Email Address" value={email} onChange={(e) => setEmail(e.target.value)} required disabled={isLoading} />
                        </motion.div>
                        ...
                        >
                            {isLoading ? <Loader className="mx-auto animate-spin" size={24} /> : "Send OTP"}
                        </motion.button>
